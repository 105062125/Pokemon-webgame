function Hospital(game) {
	...
	this.create = function () {
		...
		//加载地图
		var map = game.add.tilemap('hospital');
		...
		map.setCollision([4023]);//仅指定的tileid执行碰撞检测
		//切換到world1
		map.setTileLocationCallback(23, 23, 1, 1, this.changeworld1, this);
		...
		game.add.sprite(0, 0, 'hospital-ground'); 
		...
		game.add.sprite(0, 0, 'hospital-fore');
